...
var scoreLimit = 125; // Score limit
var enemyAmount = 5; // Amount of enemies
var bgDrawX1 = 0;
var bgDrawX2 = 1600;
var mouseX = 0;
var mouseY = 0;
...
imgSprite.src = 'images/gameArt.png';
...
Jet.prototype.updateScore = function(points) {
    //check to see if the score is greater than point limit
    if(this.score === scoreLimit){
        stopLoop();
        //draw win screen and ask if they want to play again
        drawWinScreen(); //MAKE A SPRITE ATTACHMENT FOR THE WIN SCREEN
        this.score = 0;  
...
function Boss(){
    ...
    this.drawX; 
    this.drawY; 
    this.hasHit = false;        //if the boss has been hit  
    this.bullets = [];
    this.currentBullet = 0;
    for (var i = 0; i < 25; i++) {
        this.bullets[this.bullets.length] = new Bullet(this);
